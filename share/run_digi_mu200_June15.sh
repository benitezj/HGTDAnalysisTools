...
Digi_tf.py \
    ...
    --inputLowPtMinbiasHitsFile /nfs/uiowapc/data/det-hgtd/hits/SiHit_June15/mc15_valid.361034.Pythia8EvtGen_A2MSTW2008LO_minbias_inelastic_low.evgen.EVNT.e4800/HITS_*.root \
    --inputHighPtMinbiasHitsFile /nfs/uiowapc/data/det-hgtd/hits/SiHit_June15/mc15_valid.361035.Pythia8EvtGen_A2MSTW2008LO_minbias_inelastic_high.evgen.EVNT.e4800/HITS_*.root \
