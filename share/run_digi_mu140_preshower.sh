...
Digi_tf.py \
    ...
    --conditionsTag OFLCOND-MC12-ITK-F-29-140-25 \
    --digiSeedOffset1 1${RNDMSEED} \
    --digiSeedOffset2 1${RNDMSEED}001 \
    --inputLowPtMinbiasHitsFile /nfs/uiowapc/data/det-hgtd/hits/SiHit_April12_Preshower/mc15_valid.361034.Pythia8EvtGen_A2MSTW2008LO_minbias_inelastic_low.evgen.EVNT.e4800/HITS_*.root \
    --inputHighPtMinbiasHitsFile /nfs/uiowapc/data/det-hgtd/hits/SiHit_April12_Preshower/mc15_valid.361035.Pythia8EvtGen_A2MSTW2008LO_minbias_inelastic_high.evgen.EVNT.e4800/HITS_*.root \
    --numberOfLowPtMinBias=139.567 \
    --numberOfHighPtMinBias=0.432946 \
    --pileupFinalBunch 6 \
