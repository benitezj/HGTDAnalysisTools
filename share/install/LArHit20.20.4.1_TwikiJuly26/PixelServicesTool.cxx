...
void PixelServicesTool::buildServices(const PixelGeoBuilderBasics* basics, std::vector<InDetDD::TubeZone*> svcRegions )
{
  ...
  endcapZmax = 3475.;
  pixelZmax  = 3475.;
  std::cout << "HGTD PixelServicesTool reset ZMax PIXEL  to " << pixelZmax  << " from " << genDBHelper.getCommonHalfLength() << std::endl;
  std::cout << "HGTD PixelServicesTool reset ZMax ENDCAP to " << endcapZmax << " from " << genDBHelper.getEndcapZMax() << std::endl;
