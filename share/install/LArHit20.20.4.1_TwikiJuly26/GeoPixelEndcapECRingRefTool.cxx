...
void GeoPixelEndcapECRingRefTool::preBuild(const PixelGeoBuilderBasics* basics)
{
  ...
  m_endcapZMax = 3475.;
  std::cout << "HGTD GeoPixelEndcapECRingRefTool m_endcapZmax " << genDBHelper.getEndcapZMax() << " set to " << m_endcapZMax << std::endl;
  ...
  //  ... else : build encompassing pixel region + ring layer regions
    ...
    double pixelZmax = 3475.;
    std::cout<<"HGTD GeoPixelEndcapECRingRefTool pixelZmax "<< genDBHelper.getCommonHalfLength() << " set to " << pixelZmax <<std::endl;
