...
Reco_tf.py \
    ...
    --inputLowPtMinbiasHitsFile root://eosatlas//eos/atlas/user/b/benitezj/HGTD/hits/LArHit_July26/mc15_valid.361034.Pythia8EvtGen_A2MSTW2008LO_minbias_inelastic_low.evgen.EVNT.e4800/ATLAS-P2-ITK-06-01-00_VALIDATION/CrabKissing50mrad/*.root \
    --inputHighPtMinbiasHitsFile root://eosatlas//eos/atlas/user/b/benitezj/HGTD/hits/LArHit_July26/mc15_valid.361035.Pythia8EvtGen_A2MSTW2008LO_minbias_inelastic_high.evgen.EVNT.e4800/ATLAS-P2-ITK-06-01-00_VALIDATION/CrabKissing50mrad/*.root \
